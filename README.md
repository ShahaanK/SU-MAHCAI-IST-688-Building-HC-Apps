...
| --- | --- | --- |
| Labs | `streamlit run Labs/streamlit_app.py` | Home, Lab 1, Lab 2, Lab 3, Lab 4, Lab 5 |
...
| --- | --- | --- |
| `OPENAI_API_KEY` | Lab 2, Lab 4, Lab 5, and the OpenAI option in HW 2 and HW 3 | https://platform.openai.com/api-keys |
