...
| HW Manager | `streamlit run HW_Manager.py` | HW 1, HW 2, HW 3, HW 4 |
...
| --- | --- | --- |
| `OPENAI_API_KEY` | Lab 2, Lab 4, HW 4, and the OpenAI option in HW 2 and HW 3 | https://platform.openai.com/api-keys |
